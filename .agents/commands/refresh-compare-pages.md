...
Research and refresh Valence marketing comparison content using current official sources, not stale model memory.
...
- Use fresh official sources for every unstable claim:
  - Valence: `valence.sh`, `docs.valence.sh`, Valence changelog, and relevant repo/docs files
...
- Valence being framed too narrowly when the current product includes more surface area
...
- make the body explicitly enumerate:
  ...
  - important Valence positioning changes added to the copy
...
- `marketing: refresh compare pages with current Valence chat/browser/MCP positioning`
