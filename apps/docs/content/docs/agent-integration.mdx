...
Valence includes a built-in chat panel for AI interactions without leaving the app.
...
- **Model Override** - Optional model override for Valence Chat
...
- **On** - Terminal agents run their command right away, and Valence Chat sends the task prompt immediately
- **Off** - Terminal agents stage the command without pressing Enter, and Valence Chat opens as a draft instead
