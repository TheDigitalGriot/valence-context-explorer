---
title: Installation
description: Get up and running with Valence in minutes
---

<YouTubeVideo id="7jhPfMDwTUc" title="Valence Demo" thumbnail="/images/video-thumbnail.png" />

## Quick Start

1. **Download** - Get Valence for macOS
