...
- **macOS manifest**: `https://github.com/valence-sh/valence/releases/latest/download/latest-mac.yml`
- **Linux manifest**: `https://github.com/valence-sh/valence/releases/latest/download/latest-linux.yml`
- **macOS installer**: `https://github.com/valence-sh/valence/releases/latest/download/Valence-arm64.dmg`
- **Linux installer**: `https://github.com/valence-sh/valence/releases/latest/download/Valence-x64.AppImage`
