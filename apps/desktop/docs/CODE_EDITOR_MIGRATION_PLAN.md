...
- basic find support
- theme application using existing Valence theme tokens
...
- map Valence theme tokens to a shared editor theme contract
...
2. Should find be implemented with native CodeMirror search UI, or should it continue to route through Valence-owned UI controls?
