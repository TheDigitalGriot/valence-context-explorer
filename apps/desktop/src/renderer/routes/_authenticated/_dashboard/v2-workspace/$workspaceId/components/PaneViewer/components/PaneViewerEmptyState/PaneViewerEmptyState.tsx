...
import valenceEmptyStateWordmark from "renderer/screens/main/components/WorkspaceView/ContentView/TabsContent/assets/valence-empty-state-wordmark.svg";
