import { useConversationContext } from "@valence/ui/ai-elements/conversation";
import {
	HoverCard,
	HoverCardContent,
	HoverCardTrigger,
...
function buildPreview(message: ChatMessage): string {
	const textContent = message.content
		...
		.map((part: Extract<ChatMessagePart, { type: "text" }>) => part.text.trim())
		.filter(Boolean)
		.join(" ")
		.replace(/\s+/g, " ")
		.trim();
