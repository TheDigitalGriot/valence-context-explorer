...
import * as schema from "@valence/local-db";
...
import {
	ensureValenceHomeDirExists,
	VALENCE_HOME_DIR,
	VALENCE_SENSITIVE_FILE_MODE,
} from "../app-environment";

const DB_PATH = join(VALENCE_HOME_DIR, "local.db");
...
try {
	chmodSync(DB_PATH, VALENCE_SENSITIVE_FILE_MODE);
} catch {
