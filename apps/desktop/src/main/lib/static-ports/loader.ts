...
import { PORTS_FILE_NAME, PROJECT_VALENCE_DIR_NAME } from "shared/constants";
...
/**
 * Load and validate static ports configuration from a worktree's .valence/ports.json file.
 *
 ...
 *
 * @param worktreePath - Path to the workspace's worktree directory
 * @returns true if .valence/ports.json exists
 */
