		...
		expect(
			resolveRemoteNameForExistingPRHead({
				remotes: [
					{
						name: "origin",
						fetchUrl: "git@github.com:valence-sh/valence.git",
					},
				],
				pr: {
		...
		expect(
			resolveRemoteNameForExistingPRHead({
				remotes: [
					...
					{
						name: "kitenite",
						fetchUrl: "git@github.com:kitenite/valence.git",
						pushUrl: "git@github.com:kitenite/valence.git",
					},
				],
				pr: {
					headRepositoryOwner: "kitenite",
					headRepositoryName: "valence",
