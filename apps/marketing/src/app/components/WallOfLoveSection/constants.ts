...
export const TESTIMONIALS: Testimonial[] = [
	...
	},
	{
		id: "11",
		content:
			"With this tool, each agent can have its own independent work environment. You can do code reviews and merges without interference from other agents' changes. An essential tool for solo developers.",
		originalContent:
			"このツールを使えば、各エージェントが独立した作業環境を確保できる。他のエージェントの変更に干渉されずに、コードレビューやマージが可能。個人開発者には必須のツール。",
		author: "kihonushi",
		handle: "@kihonushi",
		avatar: "https://unavatar.io/twitter/kihonushi",
		url: "https://x.com/kihonushi/status/2014155796247097768",
	},
	{
		id: "12",
		content:
