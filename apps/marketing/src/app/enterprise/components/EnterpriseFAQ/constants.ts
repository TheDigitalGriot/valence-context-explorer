...
export const ENTERPRISE_FAQ_ITEMS: FAQItem[] = [
	{
		question: "What is Valence Enterprise?",
		answer:
			"Valence Enterprise is Valence for teams. Reach out to learn more about what's included and how it can work for your organization.",
	},
	{
	...
	},
	{
		...
		answer:
			"Valence runs locally on your developers' machines. We don't store your code or AI conversations. Contact us to learn more about our security practices.",
	},
];
