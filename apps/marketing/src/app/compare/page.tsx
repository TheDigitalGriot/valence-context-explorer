...
export const metadata: Metadata = {
	title: "Compare Valence | AI Coding Comparisons and Guides",
	description:
		"Compare Valence with Cursor, Claude Code, Codex, Windsurf, Devin, GitHub Copilot, and more. Browse side-by-side comparisons, roundups, and workflow guides.",
	alternates: {
		canonical: "/compare",
	},
	openGraph: {
			...
			<header className="relative border-b border-border">
				<div className="max-w-3xl mx-auto px-6 pt-16 pb-10 md:pt-20 md:pb-12 relative">
					...
					<h1 className="text-3xl md:text-4xl font-medium tracking-tight text-foreground mt-4">
						Valence vs the Alternatives
					</h1>
					<p className="text-muted-foreground mt-3 max-w-lg">
						See how Valence compares to other AI coding tools — from AI editors
