...
import { ThemePreviewCard } from "@valence/ui/theme-preview-card";
...
export const metadata: Metadata = {
	title: "Themes",
	description:
		"Browse Valence theme files shared by the community, including GitHub Dark Colorblind, Catppuccin, Ember, and One Dark Pro.",
	alternates: {
