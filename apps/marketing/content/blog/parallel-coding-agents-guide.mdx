...
Tools like [Valence](https://valence.sh) handle orchestration end-to-end:
...
1. **Pick an orchestrator** — [Valence](https://valence.sh) handles worktrees, sessions, and review
