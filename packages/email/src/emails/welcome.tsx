...
export function WelcomeEmail({ userName = "there" }: WelcomeEmailProps) {
	return (
		<StandardLayout preview="Welcome to Valence! Let's get you started.">
			<Heading style={heading}>Welcome to Valence, {userName}!</Heading>

			<Text style={paragraph}>
				Thanks for joining Valence. We're excited to help you automate your
			...
			<Button href="https://app.valence.sh/onboarding">Get Started</Button>

			<Text style={footer}>
				Need help getting started? Check out our{" "}
				<a href="https://valence.sh/docs" style={link}>
					documentation
				</a>{" "}
				or reach out to our{" "}
				<a href="https://valence.sh/support" style={link}>
					support team
				</a>
				.
			</Text>
