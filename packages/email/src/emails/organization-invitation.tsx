...
export function OrganizationInvitationEmail({
	...
	inviteLink = "https://app.valence.sh/accept-invitation/123?token=abc",
	role = "member",
	...
	return (
		...
		>
			<Heading className="text-lg font-normal leading-7 mb-8 text-foreground text-center">
				Join <strong>{organizationName}</strong> on <strong>Valence</strong>
			</Heading>
			...
			<Text className="text-base leading-[26px] text-foreground mb-4">
				...
				<strong>{organizationName}</strong> on Valence as a{" "}
				<strong>{roleDisplay}</strong>.
			</Text>

			<Text className="text-base leading-[26px] text-foreground mb-4">
				Valence helps teams automate workflows, manage tasks, and collaborate
