...
import { type FileChangeEvent, type ParsedMessage } from '../types';
import { parseJsonlFile, parseJsonlLine } from '../internal-utils/jsonl';
import { getProjectsBasePath, getTodosBasePath } from '../internal-utils/pathDecoder';
...
// NotificationManager is not included in this package — will be rebuilt.
// Minimal interface to keep error detection wiring compilable.
